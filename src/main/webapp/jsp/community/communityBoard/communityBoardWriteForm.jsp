...
<div class ="page-body">
	<div class ="writeTable">
		<form id = "communityBoardWriteForm" name = "communityBoardWriteForm" method = "post" enctype = "multipart/form-data" style = "position: relative;">
			<table>
				<colgroup>
					<col width = "135">
					<col width = "395">
