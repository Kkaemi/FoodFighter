...
<div class="container" style="margin-top : 95px; margin-bottom: 10px;">
	<div class="page-header" style = "border-bottom : none !important;">
    	<h2 class="text-center" style="margin-bottom: 20px;">커뮤니티 자유게시판</h2> 
  		<p class="text-center" style ="font-size: medium; font-weight: bold;">답글</p>      
  	</div>
</div>
<div class ="page-body">
	<div class ="writeTable">
		<form id = communityBoardReplyForm name = "communityBoardReplyForm" method = "post" enctype = "multipart/form-data" style = "position: relative;">
			<table>
				<colgroup>
					<col width = "135">
					<col width = "395">
		...
		<div class = "btn_area clearfix">
			<a href = "#">
				<span class = "btn-o" id ="reply">글쓰기</span></a>
			<c:choose>
				<c:when test="${bSrchOption != null and bKeyword != null }">
					<a href = "communityBoardView?bseq=${pseq }&bSrchOption=${bSrchOption}&bKeyword=${bKeyword}">
						<span class = "btn-o">취소</span></a>
				</c:when>
				<c:otherwise>
					<a href = "communityBoardView?bseq=${pseq }">
						<span class = "btn-o">취소</span></a>
				</c:otherwise>
			</c:choose>
		</div>
