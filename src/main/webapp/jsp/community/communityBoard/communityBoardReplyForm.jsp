...
<div class ="page-body">
	<div class ="writeTable">
		<form id = communityBoardReplyForm method = "post" enctype = "multipart/form-data" style = "position: relative;">
				<table>
					<colgroup>
						<col width = "135">
						<col width = "395">
					...
					<tbody>
						<tr>
							...
							<td colspan="3">
								<div class ="title">
									<input type = "text" id ="subject" class ="subject" value ="Re:"> <!-- 경고 모달 -->
								</div>
