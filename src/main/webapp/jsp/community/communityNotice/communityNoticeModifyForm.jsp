...
<div class ="page-body">
	<div class ="writeTable">
		<form id = communityNoticeModifyForm name = "communityNoticeModifyForm" method = "post" enctype = "multipart/form-data" style = "position: relative;">
			<table>
				<colgroup>
					<col width = "135">
					<col width = "395">
				...
				<tbody>
					<tr>
						...
						<td colspan="3">
							<div class ="title">
								<input type = "text" id ="subject" name = "subject" class ="subject" value="${cNDTO.subject }">
							</div>
						</td>
					</tr>
					<tr>
			...
			<input type = "hidden" id = "nSrchOption" name = "nSrchOption" value = "${nSrchOption }">
			<input type = "hidden" id = "nKeyword" name = "nKeyword" value = "${nKeyword }">
		</form>
		<div class = "btn_area clearfix">
			...
			<c:choose>
				<c:when test="${nSrchOption != null and nKeyword != null }">
					<a href = "communityNoticeView?seq=${seq }&nSrchOption=${nSrchOption}&nKeyword=${nKeyword}">
						<span class = "btn-o">취소</span></a>
				</c:when>
				<c:otherwise>
					<a href = "communityNoticeView?seq=${seq }">
						<span class = "btn-o">취소</span></a>
				</c:otherwise>
			</c:choose>
		</div>
...
<script type="text/javascript">$(document).ready(function(){
	 $("#summernote").summernote('code',  '${cNDTO.content}');
})
</script>
</body>
</html>